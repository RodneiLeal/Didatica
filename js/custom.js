...
if ($('.kopa-demo-widget').length > 0) {

    Modernizr.load([{
        load: ['js/jquery.matchHeight-min.js'],
        complete: function () {

            var post_4 = $('.kopa-demo-widget').find("ul.row");
...
if ($('.kopa-plugin-widget').length > 0) {

    Modernizr.load([{
        load: ['js/jquery.matchHeight-min.js'],
        complete: function () {

            var post_5 = $('.kopa-plugin-widget').find("ul.row");
...
============================================================ */
	...
	$('a.it-scroll-down[href*=#]:not([href=#])').click(function() {
